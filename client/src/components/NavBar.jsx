...
import { FaSearch, FaHome, FaBriefcase, FaCommentDots, FaUserCircle, FaSignOutAlt } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-6">
          ...
          <Link to="/" className="flex items-center">
            <h1 className="text-2xl font-bold text-[#1aac83] transition">ElKhadema</h1>
          </Link>
          ...
          {user ? (
            ...
            <div className="flex items-center gap-4">
              <Link to="/login" className="px-4 py-2 text-[#1aac83] font-medium rounded-lg transition">
                Login
              </Link>
              <Link to="/signup" className="px-4 py-2 bg-[#1aac83] text-white font-medium rounded-lg hover:bg-[#158f6b] transition">
                Sign up
              </Link>
            </div>
          )}
