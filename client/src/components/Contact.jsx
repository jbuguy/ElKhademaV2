...
export default function Contact({ contact }) {
  ...
  return <div className="flex gap-4 items-center cursor-pointer" onClick={() => openChat({ _id: contact._id, displayName: members[0].username, displayPic: members[0].profilePic })}>
