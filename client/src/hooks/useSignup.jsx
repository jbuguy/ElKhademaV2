    ...
    const signup = async (email, password, role = "user", userData) => {
        ...
        try {
            ...
            if (
                ...
                userData.phoneNumber.trim().length != 8
            ) {
    ...
    const signupCompany = async (
        ...
        try {
            ...
            if (companyData.founderName.trim().length < 3) {
                throw new Error(
                    "Founder name must be at least 3 characters long",
                );
            }
            ...
            if (desc.length < 50) {
                throw new Error(
                    `Description too short (${desc.length}/50 min chars)`,
                );
            }
            if (desc.length > 1000) {
            ...
            try {
                ...
                throw new Error(
                    "Invalid Website URL. Make sure it starts with http:// or https://",
                );
            }
